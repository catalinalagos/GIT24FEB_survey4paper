...
//hardcoded stemma
var EmotionList1 = [
  [191, 43, 33], 'anger', 'angry', 'indign', 'resent', 'annoy', 'dissatisf', 'frustr', "freak out", 'irritab',
  'bad mood'
];
var EmotionList2 = [
...
var envActionsPosList = [4, 'support', 'inclusiveness', 'inclusion', 'inclusivity', 'includ', 'sociali', 'engag', 'involv'];
